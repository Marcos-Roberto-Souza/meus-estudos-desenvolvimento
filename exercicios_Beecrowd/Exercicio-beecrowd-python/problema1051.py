...
'''
impostoRenda = 0
rendaSalarial = float(input())

if rendaSalarial > 0.0 and rendaSalarial <= 2000.00:
    print("Isento")
elif rendaSalarial > 2000.00 and rendaSalarial <= 3000.00:
    impostoRenda = (rendaSalarial - 2000)*0.08
    print(f"R$ {impostoRenda:.2f}")
elif rendaSalarial > 3000.00 and rendaSalarial <= 4500.00:
    impostoRenda = 1000 * 0.08
    impostoRenda += (rendaSalarial-3000)* 0.18
    print(f"R$ {impostoRenda:.2f}")
elif rendaSalarial > 4500.00:
    impostoRenda = 1000 * 0.08
