...
// Padrão Factory e Strategy.




namespace ProjetoCodigoSujo_4SOLIDPadroes;

public class CalculadoraDeDesconto
{
    public decimal CalcularDesconto(decimal precoDoProduto,
        decimal precoProduto,       StatusDaConta statusDaConta,
                                    int tempoDeContaEmAnos)
    {
        decimal precoDepoisDoDesconto = 0;
        decimal percentualDoDescontoPorFidelidade = tempoDeContaEmAnos > Constantes.DESCONTO_MAXIMO_POR_FIDELIDADE ?
        ...
        switch(statusDaConta)
        {
            ...
            case StatusDaConta.ClienteEspecial:
                precoDepoisDoDesconto = CalcularPrecoDepoisDoDesconto(precoDoProduto, Constantes.DESCONTO_CLIENTE_ESPECIAL , percentualDoDescontoPorFidelidade);
                
                break;

            case StatusDaConta.ClienteOuro:
                precoDepoisDoDesconto = CalcularPrecoDepoisDoDesconto(precoDoProduto, Constantes.DESCONTO_CLIENTE_OURO , percentualDoDescontoPorFidelidade);
                
                break;

            case StatusDaConta.ClienteVIP:
                precoDepoisDoDesconto = CalcularPrecoDepoisDoDesconto(precoDoProduto, Constantes.DESCONTO_CLIENTE_VIP, percentualDoDescontoPorFidelidade);
