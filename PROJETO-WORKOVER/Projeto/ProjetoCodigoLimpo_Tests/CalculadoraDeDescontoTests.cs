...
namespace ProjetoCodigoLimpo_Tests
{
    public class CalculadoraDeDescontoTests
    {
        ...
        public CalculadoraDeDescontoTests()
        {
            ...
            serviceCollection.AddTransient<ICalculadoraDeDescontoPorFidelidade,
                                           CalculadoraDescontoProFidelidade>();
            ...
            _calculadoraDeDesconto = serviceProvider.GetService<CalculadoraDeDesconto>()
                                    ?? throw new InvalidOperationException("A instância de CalculadoraDeDesconto não pode ser criada. ");
        }
        [Theory]
        ...
        public void CalculadoraDesconto_ValidInputs_ReturnsExpectedResult(decimal precoProduto,
